## The script has been entirely repurposed from the Azure Key Vault documentation code sample
## available at https://www.microsoft.com/en-us/download/details.aspx?id=45343
## Additional scripts have been added for the purpose of this article
...
#************************************************************************************************
# Create a Certificate in AKV, having a private key in HSM and non exportable
#************************************************************************************************
